...
from ProposedAlgorithms import count_month,GAWG,CUAM,belong_level_GAWG,print_com,transf,com_to_group,change,generate_patches,quality,col_map_level,transf_cases_gto,CDAD,dis_fact_half,mat_dis_norm_max
...
belong_fact=belong_level_GAWG(u_per)
...
#Belonging level of each node to its respective community
belong4_jun_feb=belong_level_GAWG(u4_jun_feb)
print()
